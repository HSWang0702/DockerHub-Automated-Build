...
DEFINE_string(i, "/raid/oscar/Custom_Data/FDDB_GT_20/ImageSets/Main/test_01.txt", video_message);
...
DEFINE_string(output_name, "detection_results", "Output file name");

DEFINE_string(output_dir, "", "Output directory name");
...
static void showUsage() {
    ...
    std::cout << "    -output_name               " << "Output file name" << std::endl;
    std::cout << "    -output_dir                " << "Output directory name" << std::endl;
}
